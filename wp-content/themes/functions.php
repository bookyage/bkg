...
//	register_nav_menu('footer-menu','Footer Menu');
    ...
    add_image_size('home_slide',640,440,true);
  
    add_image_size('blog-img',865,300,true);
   
    add_image_size('home-image',368,393,true);
    add_image_size('side-post-image',354,374,true);
}
